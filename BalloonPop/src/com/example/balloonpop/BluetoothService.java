...
public class BluetoothService {
    ...
    private static final UUID MY_UUID_SECURE =
        ...
        UUID.fromString("d5693b70-ccfa-11e2-8b8b-0800200c9a66");
    private static final UUID MY_UUID_INSECURE =
    	//UUID.fromString("00001101-0000-1000-8000-00805f9b34fb");
        UUID.fromString("d5696280-ccfa-11e2-8b8b-0800200c9a66");
     ...
     */
    private void connectionFailed(String cause) {
        // Send a failure message back to the Activity
        Message msg = mHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MainActivity.TOAST, "Unable to connect device:" + cause);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
